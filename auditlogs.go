...
// AuditLog is an resource that represents an update in the khulnasoft dash.
...
// AuditLogResponse is the response returned from the khulnasoft v4 api.
...
//
// API Reference: https://api.khulnasoft.com/#audit-logs-list-organization-audit-logs
...
// filtered based on any argument in the AuditLogFilter.
//
// API Reference: https://api.khulnasoft.com/#audit-logs-list-user-audit-logs
