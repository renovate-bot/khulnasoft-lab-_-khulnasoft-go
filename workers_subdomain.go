...
//
// API reference: https://developers.khulnasoft.com/api/operations/worker-subdomain-create-subdomain
...
//
// API reference: https://developers.khulnasoft.com/api/operations/worker-subdomain-get-subdomain
