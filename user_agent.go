...
//
// API reference: https://api.khulnasoft.com/#user-agent-blocking-rules-create-a-useragent-rule
...
//
// API reference: https://api.khulnasoft.com/#user-agent-blocking-rules-update-useragent-rule
...
//
// API reference: https://api.khulnasoft.com/#user-agent-blocking-rules-delete-useragent-rule
...
//
// API reference: https://api.khulnasoft.com/#user-agent-blocking-rules-useragent-rule-details
...
//
// API reference: https://api.khulnasoft.com/#user-agent-blocking-rules-list-useragent-rules
