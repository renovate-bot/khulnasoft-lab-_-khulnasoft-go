...
func TestIntelligence_DomainDetails(t *testing.T) {
  ...
  "result": {
	...
	out, err := client.IntelligenceDomainDetails(context.Background(), GetDomainDetailsParameters{AccountID: testAccountID, Domain: "khulnasoft.com"})
...
func TestIntelligence_BulkDomainDetails(t *testing.T) {
  ...
  "result": [
	...
	out, err := client.IntelligenceBulkDomainDetails(context.Background(), GetBulkDomainDetailsParameters{AccountID: testAccountID, Domains: []string{"khulnasoft.com"}})
	if assert.NoError(t, err) {
...
func TestIntelligence_DomainHistory(t *testing.T) {
  ...
  "result": [
	...
	out, err := client.IntelligenceDomainHistory(context.Background(), GetDomainHistoryParameters{AccountID: testAccountID, Domain: "khulnasoft.com"})
	if assert.NoError(t, err) {
