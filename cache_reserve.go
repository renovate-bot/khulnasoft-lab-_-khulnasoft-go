...
//
// API reference: https://developers.khulnasoft.com/api/operations/zone-cache-settings-get-cache-reserve-setting
...
//
// API reference: https://developers.khulnasoft.com/api/operations/zone-cache-settings-change-cache-reserve-setting
