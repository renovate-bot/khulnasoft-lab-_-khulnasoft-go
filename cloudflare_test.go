...
func setup(opts ...Option) {
	...
	// Khulnasoft client configured to use test server
	client, _ = New("deadbeef", "khulnasoft@example.org", opts...)
...
func TestClient_Headers(t *testing.T) {
	...
	mux.HandleFunc("/user", func(w http.ResponseWriter, r *http.Request) {
		...
		assert.Equal(t, "khulnasoft@example.org", r.Header.Get("X-Auth-Email"))
...
func TestClient_ContextIsPassedToRequest(t *testing.T) {
	...
	cfClient, _ := New("deadbeef", "khulnasoft@example.org", HTTPClient(httpClient))
