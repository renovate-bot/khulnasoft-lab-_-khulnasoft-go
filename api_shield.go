...
//
// API documentation: https://api.khulnasoft.com/#api-shield-settings-retrieve-information-about-specific-configuration-properties
...
//
// API documentation: https://api.khulnasoft.com/#api-shield-settings-set-configuration-properties
