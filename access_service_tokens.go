...
// in place.
//
// API reference: https://api.khulnasoft.com/#access-service-tokens-refresh-a-service-token
...
// Token in place.
// API reference: https://api.khulnasoft.com/#access-service-tokens-rotate-a-service-token
