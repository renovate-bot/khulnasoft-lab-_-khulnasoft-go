...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-short-lived-certificate-c-as-list-short-lived-certificate-c-as
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-short-lived-certificate-c-as-list-short-lived-certificate-c-as
...
// Access.
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-short-lived-certificate-c-as-get-a-short-lived-certificate-ca
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-short-lived-certificate-c-as-get-a-short-lived-certificate-ca
...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-short-lived-certificate-c-as-create-a-short-lived-certificate-ca
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-short-lived-certificate-c-as-create-a-short-lived-certificate-ca
...
// AccessApplication.
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-short-lived-certificate-c-as-delete-a-short-lived-certificate-ca
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-short-lived-certificate-c-as-delete-a-short-lived-certificate-ca
