...
//
// API reference: https://api.khulnasoft.com/#devices-get-local-domain-fallback-list
...
//
// API reference: https://api.khulnasoft.com/#devices-set-local-domain-fallback-list
