...
//
// API reference: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-list-address-maps
...
//
// API reference: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-create-address-map
...
//
// API reference: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-address-map-details
...
//
// API reference: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-update-address-map
...
//
// API reference: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-delete-address-map
...
//
// API reference: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-add-an-ip-to-an-address-map
...
//
// API reference: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-remove-an-ip-from-an-address-map
...
//
// API reference:
//   - account: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-add-an-account-membership-to-an-address-map
//   - zone: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-add-a-zone-membership-to-an-address-map
...
//
// API reference:
//   - account: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-remove-an-account-membership-from-an-address-map
//   - zone: https://developers.khulnasoft.com/api/operations/ip-address-management-address-maps-remove-a-zone-membership-from-an-address-map
