			...
			"result": [
				{
      				...
      				"redirect": {
						"source_url": "http://khulnasoft.com",
						"include_subdomains": true,
						"target_url": "https://khulnasoft.com",
						"status_code": 302,
						"preserve_query_string": true,
						"subpath_matching": true,
						"preserve_path_suffix": false
					},
      				"comment": "Khulnasoft http redirect",
      				"created_on": "2020-01-01T08:00:00Z",
      				"modified_on": "2020-01-10T14:00:00Z"
    			}
  			],
	...
	want := []ListItem{
		{
			ID: "0c0fc9fa937b11eaa1b71c4d701ab86e",
			Redirect: &Redirect{
				SourceUrl:           "http://khulnasoft.com",
				IncludeSubdomains:   BoolPtr(true),
				TargetUrl:           "https://khulnasoft.com",
