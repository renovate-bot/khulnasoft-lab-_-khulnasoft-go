...
// account.
//
// API reference : https://api.khulnasoft.com/#device-managed-networks-list-device-managed-networks
...
//
// API reference: https://api.khulnasoft.com/#device-managed-networks-create-device-managed-network
...
//
// API reference: https://api.khulnasoft.com/#device-managed-networks-update-device-managed-network
...
//
// API reference: https://api.khulnasoft.com/#device-managed-networks-device-managed-network-details
...
//
// API reference: https://api.khulnasoft.com/#device-managed-networks-delete-device-managed-network
