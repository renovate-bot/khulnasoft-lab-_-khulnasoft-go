...
//
// API Reference: https://api.khulnasoft.com/#total-tls-total-tls-settings-details
...
//
// API Reference: https://api.khulnasoft.com/#total-tls-enable-or-disable-total-tls
