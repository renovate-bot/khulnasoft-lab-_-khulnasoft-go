...
//
// API reference: https://api.khulnasoft.com/#dlp-payload-log-settings-get-settings
...
//
// API reference: https://api.khulnasoft.com/#dlp-payload-log-settings-update-settings
