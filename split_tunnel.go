...
//
// API reference for include: https://api.khulnasoft.com/#device-policy-get-split-tunnel-include-list
// API reference for exclude: https://api.khulnasoft.com/#device-policy-get-split-tunnel-exclude-list
...
//
// API reference for include: https://api.khulnasoft.com/#device-policy-set-split-tunnel-include-list
// API reference for exclude: https://api.khulnasoft.com/#device-policy-set-split-tunnel-exclude-list
