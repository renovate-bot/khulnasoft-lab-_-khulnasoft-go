...
//
// API reference: https://developers.khulnasoft.com/api/operations/worker-account-settings-create-worker-account-settings
...
//
// API reference: https://developers.khulnasoft.com/api/operations/worker-account-settings-fetch-worker-account-settings
