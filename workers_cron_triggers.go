...
// script.
//
// API reference: https://developers.khulnasoft.com/api/operations/worker-cron-trigger-get-cron-triggers
...
//
// API reference: https://developers.khulnasoft.com/api/operations/worker-cron-trigger-update-cron-triggers
