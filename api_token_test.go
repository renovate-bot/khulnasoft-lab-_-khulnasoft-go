...
func TestAPITokens(t *testing.T) {
	...
	resources["com.khulnasoft.api.account.zone.eb78d65290b24279ba6f44721b3ea3c4"] = "*"
	resources["com.khulnasoft.api.account.zone.22b1de5f1c0e4b3ea97bb1e963b06a43"] = "*"
...
func TestListAPITokensPermissionGroups(t *testing.T) {
		  ...
		  "result": [
			{
				"id": %q,
				"name": "DNS Read",
				"scopes": ["com.khulnasoft.api.account.zone"]
			}
		  ]
		}
		`, pgID)
	...
	want := []APITokenPermissionGroups{{
		ID:     pgID,
		Name:   "DNS Read",
		Scopes: []string{"com.khulnasoft.api.account.zone"},
	}}
