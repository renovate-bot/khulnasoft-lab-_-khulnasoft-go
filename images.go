...
// Image represents a Khulnasoft Image.
type Image struct {
	ID                string                 `json:"id"`
...
func (b UploadImageParams) write(mpw *multipart.Writer) error {
	...
	// According to the Khulnasoft docs, this field defaults to false.
...
//
// API Reference: https://api.khulnasoft.com/#khulnasoft-images-upload-an-image-using-a-single-http-request
...
//
// API Reference: https://api.khulnasoft.com/#khulnasoft-images-update-image
...
var imagesMultipartBoundary = "----KhulnasoftImagesGoClientBoundary"

// CreateImageDirectUploadURL creates an authenticated direct upload url.
//
// API Reference: https://api.khulnasoft.com/#khulnasoft-images-create-authenticated-direct-upload-url
...
//
// API Reference: https://api.khulnasoft.com/#khulnasoft-images-list-images
...
//
// API Reference: https://api.khulnasoft.com/#khulnasoft-images-image-details
...
//
// API Reference: https://api.khulnasoft.com/#khulnasoft-images-base-image
...
//
// API Reference: https://api.khulnasoft.com/#khulnasoft-images-delete-image
...
// GetImagesStats gets an account's statistics for Khulnasoft Images.
//
// API Reference: https://api.khulnasoft.com/#khulnasoft-images-images-usage-statistics
