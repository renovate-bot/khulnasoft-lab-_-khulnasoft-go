...
// URLNormalizationSettings API reference: https://api.khulnasoft.com/#url-normalization-get-url-normalization-settings
...
// UpdateURLNormalizationSettings https://api.khulnasoft.com/#url-normalization-update-url-normalization-settings
