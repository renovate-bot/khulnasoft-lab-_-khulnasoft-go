...
func TestListWAFPackages(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		...
		// JSON data from: https://api.khulnasoft.com/#waf-rule-packages-properties
		fmt.Fprintf(w, `{
			"success": true,
			"errors": [],
			"messages": [],
...
func TestUpdateWAFPackage(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("content-type", "application/json")
		// JSON data from: https://api.khulnasoft.com/#waf-rules-properties
		fmt.Fprintf(w, `{
			"success": true,
			"errors": [],
			"messages": [],
...
func TestListWAFGroups(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		...
		// JSON data from: https://api.khulnasoft.com/#waf-rule-groups-properties
		fmt.Fprintf(w, `{
			"success": true,
			"errors": [],
			"messages": [],
...
func TestWAFGroup(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("content-type", "application/json")
		// JSON data from: https://api.khulnasoft.com/#waf-rule-groups-rule-group-details
		fmt.Fprintf(w, `{
			"success": true,
			"errors": [],
			"messages": [],
...
func TestUpdateWAFGroup(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("content-type", "application/json")
		// JSON data from: https://api.khulnasoft.com/#waf-rule-groups-edit-rule-group
		fmt.Fprintf(w, `{
			"success": true,
			"errors": [],
			"messages": [],
