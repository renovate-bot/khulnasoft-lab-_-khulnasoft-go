...
// var snippetFormat = `\u003c!-- Khulnasoft Web Analytics --\u003e\u003cscript defer src='https://static.khulnasoftinsights.com/beacon.min.js' data-cf-beacon='{\"token\": \"%s\"}'\u003e\u003c/script\u003e\u003c!-- End Khulnasoft Web Analytics --\u003e`.
var snippetFormat = `%s`
