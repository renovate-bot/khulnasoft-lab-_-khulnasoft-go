...
//
// API reference: https://api.khulnasoft.com/#user-level-firewall-access-rule-list-access-rules
...
//
// API reference: https://api.khulnasoft.com/#user-level-firewall-access-rule-create-access-rule
...
//
// API reference: https://api.khulnasoft.com/#user-level-firewall-access-rule-update-access-rule
...
// This takes an AccessRule to allow filtering of the results returned.
//
// API reference: https://api.khulnasoft.com/#firewall-access-rule-for-a-zone-list-access-rules
...
// identifier.
//
// API reference: https://api.khulnasoft.com/#firewall-access-rule-for-a-zone-create-access-rule
...
// access rule identifiers.
//
// API reference: https://api.khulnasoft.com/#firewall-access-rule-for-a-zone-update-access-rule
...
// access rule identifiers.
//
// API reference: https://api.khulnasoft.com/#firewall-access-rule-for-a-zone-delete-access-rule
...
// This takes an AccessRule to allow filtering of the results returned.
//
// API reference: https://api.khulnasoft.com/#account-level-firewall-access-rule-list-access-rules
...
// account identifier.
//
// API reference: https://api.khulnasoft.com/#account-level-firewall-access-rule-create-access-rule
...
//
// API reference: https://api.khulnasoft.com/#account-level-firewall-access-rule-access-rule-details
...
//
// API reference: https://api.khulnasoft.com/#account-level-firewall-access-rule-update-access-rule
...
//
// API reference: https://api.khulnasoft.com/#account-level-firewall-access-rule-delete-access-rule
