...
//
// API reference: https://api.khulnasoft.com/#email-routing-routing-rules-list-routing-rules
...
//
// API reference: https://api.khulnasoft.com/#email-routing-routing-rules-create-routing-rule
...
//
// API reference: https://api.khulnasoft.com/#email-routing-routing-rules-get-routing-rule
...
//
// API reference: https://api.khulnasoft.com/#email-routing-routing-rules-update-routing-rule
...
//
// API reference: https://api.khulnasoft.com/#email-routing-routing-rules-delete-routing-rule
...
//
// API reference: https://api.khulnasoft.com/#email-routing-routing-rules-get-catch-all-rule
...
//
// API reference: https://api.khulnasoft.com/#email-routing-routing-rules-update-catch-all-rule
